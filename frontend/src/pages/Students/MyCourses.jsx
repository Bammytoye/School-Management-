...
export default function MyCourses() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
            <Navbar />
            <main className="max-w-4xl sm:max-w-5xl md:max-w-6xl 2xl:max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                <Breadcrumb />
                ...
                <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
                    ...
                    {/* Stats */}
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-3 w-full sm:w-auto">
                        {loading ? (
                            Array.from({ length: 3 }).map((_, i) => (
                                <div
                                    key={i}
                                    className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2 w-full"
                                >
                            ...
                            <>
                                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2 text-center">
                                    <p className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-blue-600">
                                        {courses.length}
                                    </p>
                                ...
                                <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2 text-center">
                                    <p className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-green-600">
                                        {grades.length}
                                    </p>
                                    <p className="text-xs sm:text-sm md:text-base text-gray-500 dark:text-gray-400">
                                        Graded
                                ...
                                {presentPct !== null && (
                                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-2 text-center">
                                        <p className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-purple-600">
                                            {presentPct}%
                                        </p>
                                        <p className="text-xs sm:text-sm md:text-base text-gray-500 dark:text-gray-400">
                                            Attendance
                ...
                {/* Tabs */}
                <div className="flex flex-wrap gap-1 bg-gray-100 dark:bg-gray-800 rounded-xl p-1 mb-6 w-full sm:w-auto">
                    {[
                        ['courses', '📚 Courses'],
                        ['grades', '📊 Grades'],
                        ...
                        <button
                            key={key}
                            onClick={() => setTab(key)}
                            className={`px-4 py-2 rounded-lg text-sm sm:text-base md:text-base font-medium transition-all ${
                                tab === key
                ...
                {tab === 'courses' && (
                    loading ? (
                        ...
                        <div className="card">
                            <EmptyState
                                type="courses_student"
                                title="No courses yet"
                                description="Your admin will enrol you in courses soon."
                            />
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            {grade && (
                                                <span
                                                    className={`px-2 py-0.5 rounded-full text-sm font-bold flex-shrink-0 ${GRADE_COLORS[grade.grade] || ''
                                                        }`}
                                                >
                                                    {grade.grade}
                                                </span>
                    ...
                    loading ? (
                        ...
                        <div className="card">
                            <EmptyState
                                type="grades"
                                title="No grades yet"
                                description="Your grades will appear here once your admin has graded your courses."
                            />
                        </div>
                    ) : (
                                    ...
                                    {grades.map((g, i) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-5 py-3">
                                                <span
                                                    className={`px-2 py-0.5 rounded-full text-xs font-bold ${GRADE_COLORS[g.grade] || ''
                                                        }`}
                                                >
                                                    {g.grade}
                                                </span>
                    ...
                    loading ? (
                        ...
                        <div className="card">
                            <EmptyState
                                ...
                                description="Your attendance records will appear here once your admin starts marking attendance."
                            />
                        </div>
                    ) : (
                        <div className="overflow-x-auto bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700">
                                ...
                                <tbody>
                                    {attendance.map((a, i) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-5 py-3">
                                                <span
                                                    className={`font-medium capitalize ${STATUS_COLORS[a.status]}`}
                                                >
                                                    {a.status === 'present'
                                                        ? '✓'
                                                        : a.status === 'absent'
