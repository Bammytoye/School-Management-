    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
            ...
            <div className="relative z-10 max-w-5xl sm:max-w-6xl xl:max-w-7xl mx-auto px-4 sm:px-6 text-center py-24">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 text-xs sm:text-sm font-semibold px-4 py-1.5 rounded-full mb-6 border border-blue-200 dark:border-blue-800"
                ...
                {/* Headline */}
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 dark:text-white leading-[1.08] tracking-tight mb-6"
                ...
                <div className="flex items-center justify-center gap-4 sm:gap-6 mt-10 flex-wrap"
                    ...
                    {['✅ Free to use', '🔒 Secure & private', '📱 Mobile friendly', '⚡ Lightning fast'].map((b) => (
                        <span key={b} className="text-xs sm:text-sm md:text-base text-gray-500 dark:text-gray-400 font-medium">{b}</span>
                    ))}
                </div>
            </div>
        </section>
