            ...
            <div className="flex gap-1 bg-gray-100 dark:bg-gray-800 rounded-xl p-1 mb-6 w-fit">
                {['profile', 'password'].map((t) => (
                    <button
                        key={t}
                        onClick={() => setTab(t)}
                        className={`px-5 py-2 rounded-lg text-sm font-medium transition-all capitalize ${tab === t
                ...
                <div className="card">
                    ...
                    <form onSubmit={handleProfileSave} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input className="input bg-gray-50 dark:bg-gray-800 cursor-not-allowed capitalize" value={profile.role} disabled />
                        </div>
