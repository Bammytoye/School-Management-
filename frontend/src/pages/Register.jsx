        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-md p-8 border border-gray-200 dark:border-gray-700">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Register as a student</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input name="password" type="password" required value={form.password} onChange={handleChange} className="input" placeholder="Create a strong password" />
